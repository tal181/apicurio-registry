 ...
 * @author Ales Justin
 */
public interface CompatibilityChecker2 {
    /**
     ...
     */
    default Set isCompatibleWith(CompatibilityLevel compatibilityLevel, List<ContentHandle> existingArtifacts, ContentHandle proposedArtifact) {
     ...
     * @param proposedArtifact   MUST NOT be null
     */
    Set isCompatibleWith(CompatibilityLevel compatibilityLevel, List<String> existingArtifacts, String proposedArtifact);
}
